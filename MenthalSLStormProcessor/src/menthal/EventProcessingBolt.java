...
// has a method getEventProcessingBoltByEventName, that returns a new object of a particular bolt,
// specified by event name
...
public abstract class EventProcessingBolt extends BaseRichBolt {
  ...
  public static EventProcessingBolt getEventProcessingBoltByEventName(String eventName) {
    switch (eventName) {
      case "app_install":
        return new AppInstallBolt();
      case "app_session":
        return new AppSessionBolt();
      case "call_missed":
        return new CallMissedBolt();
      case "call_outgoing":
        return new CallOutgoingBolt();
      case "call_received":
        return new CallReceivedBolt();
      case "dreaming_started":
        return new DreamingStartedBolt();
      case "dreaming_stopped":
        return new DreamingStoppedBolt();
      case "phone_shutdown":
        return new PhoneShutdownBolt();
      case "screen_off":
        return new ScreenOffBolt();
      case "screen_on":
        return new ScreenOnBolt();
      case "screen_unlock":
        return new ScreenUnlockBolt();
      case "sms_received":
        return new SmsReceivedBolt();
      case "sms_sent":
        return new SmsSentBolt();
      case "window_state_changed":
        return new WindowStateChangedBolt();
    }
    return null;
  }
  ...
  public void prepare(Map conf, TopologyContext context, OutputCollector collector) {
    ...
    int eventCountLimit = ((Long)conf.get("eventCountLimit")).intValue();
