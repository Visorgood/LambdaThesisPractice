...
public class EventGenerator {
  ...
  private static long MAX_DURATION = 15 * 60 * 1000; // the maximal duration of the event, that has
                                                     // the field "duration" (equals to 15 minutes)
  ...
  private static GenericRecord generateEvent(String eventName) throws IOException {
    ...
    switch (eventName) {
      case "app_install":
        generateAppInstallEvent(record);
        break;
      case "app_session":
        generateAppSessionEvent(record);
        break;
      case "call_missed":
        generateCallMissedEvent(record);
        break;
      case "call_outgoing":
        generateCallOutgoingEvent(record);
        break;
      case "call_received":
        generateCallReceivedEvent(record);
        break;
      case "dreaming_started":
        generateDreamingStarted(record);
        break;
      case "dreaming_stopped":
        generateDreamingStopped(record);
        break;
      case "phone_shutdown":
        generatePhoneShutdown(record);
        break;
      case "screen_off":
        generateScreenOffEvent(record);
        break;
      case "screen_on":
        generateScreenOnEvent(record);
        break;
      case "screen_unlock":
        generateScreenUnlockEvent(record);
        break;
      case "sms_received":
        generateSmsReceivedEvent(record);
        break;
      case "sms_sent":
        generateSmsSentEvent(record);
        break;
      case "window_state_changed":
        generateWindowStateChanged(record);
        break;
    }
    return record;
  }
